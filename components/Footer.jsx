...
const Footer = () => {
  return (
    <>
      <div className='flex flex-col md:flex-row justify-center md:justify-start items-center px-6 md:px-[39px] lg:px-[165px] pt-10 md:pt-0 bg-mirageBlue '>
        <Link href={'/'}>
          <div>
            <Image
              src={logo.src}
              ...
              width={logo.width}
              height={logo.height}
              className='cursor-pointer text-waterWhite'
            />
          </div>
        </Link>
        <div className='md:flex w-full items-center justify-between md:ml-16 text-[15px] text-waterWhite  '>
          <ul className='font-bold flex items-center justify-center gap-[31px] md:gap-10 flex-col md:flex-row my-10'>
            <Link href={'/'}>
          ...
          <div className='flex items-center justify-center gap-6 mb-[55px] md:mb-0'>
            <div>
              <Link href={'https://facebook.com'} target={'_blank'}>
                <svg width='24' height='24' xmlns='http://www.w3.org/2000/svg'>
                  <path
                    ...
                    fill='#FBFCFE'
                    fillRule='nonzero'
                    className='hover:fill-charmPink cursor-pointer'
                  />
                </svg>
              </Link>
            </div>
